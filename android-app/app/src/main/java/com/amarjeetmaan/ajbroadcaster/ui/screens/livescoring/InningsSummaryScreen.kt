...
@Composable
fun InningsSummaryScreen(
    navController: NavHostController,
    viewModel: InningsSummaryViewModel = hiltViewModel()
) {
    ...
    Column(
        ...
        Column(
            ...
            AJCard {
                ...
                Text(text = "Fours: ${summary.fours}")
                Text(text = "Sixes: ${summary.sixes}")
                Text(text = "Extras: ${summary.extras}")
            }
        }
    }
}
